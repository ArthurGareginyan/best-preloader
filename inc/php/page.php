...
function spacexchimp_p007_render_submenu_page() {
    ...
    // Call messages
    spacexchimp_p007_hello_message();
    spacexchimp_p007_error_message();
    ...
    <div class="wrap">
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade active in" id="tab-core">
                <!-- INCLUDE SIDEBAR -->
                <?php require_once( SPACEXCHIMP_P007_PATH . 'inc/php/sidebar.php' ); ?>
                <!-- INCLUDE SETTINGS -->
                <?php require_once( SPACEXCHIMP_P007_PATH . 'inc/php/settings.php' ); ?>
            </div>
            <!-- END-TAB 1 -->
            ...
            <div class="tab-page fade" id="tab-usage">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><?php _e( 'To display the preloader on the front end of your website, simply follow these steps:', $text ); ?></p>
                        <ol class="custom-counter">
                            <li><?php _e( 'Go to the "Settings" tab.', $text ); ?></li>
                            <li><?php _e( 'Select the desired settings.', $text ); ?></li>
                            <li><?php _e( 'Click the "Save changes" button.', $text ); ?></li>
                            <li><?php _e( 'Enjoy your fancy preloader.', $text ); ?> <?php _e( 'It\'s that simple!', $text ); ?></li>
                        </ol>
            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-3"><?php _e( 'On the "Settings" tab, select the desired settings and click the "Save changes" button. Enjoy your fancy preloader. It\'s that simple!', $text ); ?></div>

                        <div class="question-4"><?php _e( 'How can I upload my image?', $text ); ?></div>
                        <div class="answer-4"><?php _e( 'You can put the URL of image to the "Preloader image" field.', $text ); ?></div>
            ...
            <div class="tab-page fade" id="tab-support">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <img src="<?php echo SPACEXCHIMP_P007_URL . 'inc/img/thanks.png'; ?>" alt="Thanks!" class="pull-right">
