                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            ...
                            <?php _e( 'Enjoy your fancy preloader.', $plugin['text'] ); ?>
                            <?php _e( 'It\'s that simple!', $plugin['text'] ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'How can I upload my image?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'You can put the URL of image to the "Preloader image" field.', $plugin['text'] ); ?>
                        </div>
