        ...
        <div id="post-body-content" class="has-sidebar-content">
            <div class="meta-box-sortabless">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><?php _e( 'To display the preloader on the front end of your website, simply follow these steps:', $plugin['text'] ); ?></p>
                        <ol class="custom-counter">
                            ...
                            <li><?php _e( 'Enjoy your fancy preloader.', $plugin['text'] ); ?> <?php _e( 'It\'s that simple!', $plugin['text'] ); ?></li>
                        </ol>
                        <p class="note">
                            <?php
                                printf(
