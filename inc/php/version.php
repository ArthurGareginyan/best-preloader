 ...
 * @since 4.1
 */
function bestpreloader_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( BESTPL_SETTINGS . '_service_info', $info );
...
bestpreloader_plugin_version_number();
