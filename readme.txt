...
Easily add cross browser animated preloader to your website. It will be responsive and compatible with all major browsers. It will work with any theme!
...
After installation and activation, the "`Preloader`" menu item will appear in the "`Space X-Chimp`" section of Admin Panel. Click on it in order to view the plugin settings page.
...
You can find the plugin settings page at "`WP Admin Panel`" -> "`Space X-Chimp`" -> "`Preloader`".
