...
defined('BESTPL_VERSION') or define('BESTPL_VERSION', '3.2');
...
function bestpreloader_settings_link( $links ) {
	$settings_page = '<a href="' . admin_url( 'options-general.php?page=best-preloader.php' ) .'">' . __( 'Settings', BESTPL_TEXT ) . '</a>';
...
function bestpreloader_register_submenu_page() {
	add_options_page( __( 'Preloader', BESTPL_TEXT ), __( 'Preloader', BESTPL_TEXT ), 'manage_options', basename( __FILE__ ), 'bestpreloader_render_submenu_page' );
}
