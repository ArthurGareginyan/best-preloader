...
function bestpreloader_define_constants( $constant_name, $value ) {
    $constant_name = 'BESTPL_' . $constant_name;
    if ( !defined( $constant_name ) )
        define( $constant_name, $value );
}
bestpreloader_define_constants( 'DIR', dirname( plugin_basename( __FILE__ ) ) );
bestpreloader_define_constants( 'BASE', plugin_basename( __FILE__ ) );
bestpreloader_define_constants( 'URL', plugin_dir_url( __FILE__ ) );
bestpreloader_define_constants( 'PATH', plugin_dir_path( __FILE__ ) );
bestpreloader_define_constants( 'SLUG', dirname( plugin_basename( __FILE__ ) ) );
bestpreloader_define_constants( 'NAME', $plugin_data['name'] );
bestpreloader_define_constants( 'VERSION', $plugin_data['version'] );
bestpreloader_define_constants( 'TEXT', $plugin_data['text'] );
bestpreloader_define_constants( 'PREFIX', 'bestpreloader' );
bestpreloader_define_constants( 'SETTINGS', 'bestpreloader' );
